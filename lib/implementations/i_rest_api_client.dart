...
abstract class IRestApiClient {
  ...
  Future<Result<T>> getCached<T>(String path,
      {Map<String, dynamic>? queryParameters,
      T Function(dynamic data)? parser});
  Stream<Result<T>> getStreamed<T>(String path,
      {Map<String, dynamic>? queryParameters,
      T Function(dynamic data)? parser});
  ...
  Future<Result<T>> post<T>(String path,
      ...
      Map<String, dynamic>? queryParameters,
      T Function(dynamic data)? parser});
  Future<Result<T>> postCached<T>(String path,
      {data,
      Map<String, dynamic>? queryParameters,
      T Function(dynamic data)? parser});
  Stream<Result<T>> postStreamed<T>(String path,
      {data,
      Map<String, dynamic>? queryParameters,
      T Function(dynamic data)? parser});
  ...
  Future<Result<T>> head<T>(String path,
      {data,
      Map<String, dynamic>? queryParameters,
      T Function(dynamic data)? parser});
  ...
  Future<Result> download(String urlPath, savePath,
